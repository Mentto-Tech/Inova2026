...
import citapLogoInova from '../../assets/inovaskill/citapInovaPage.png'
      ...
      <div className="site">
        <section className="hero animate-fade-in" ref={heroRef}>
          <div className="hero-left">
            ...
            <h1 className="h1-title">
              Intraempreendedorismo e <span className="accent">Inovação Aberta</span> na Região da <span className="accent">Alta Paulista</span>
            </h1>
          ...
          <div className="stats-container">
            ...
            <div className="stats-grid">
              ...
              <div className="stat-item">
                ...
                <div className="stat-label">Horas de mentoria<br />e tutoria<br />realizadas</div>
              </div>
        ...
        <section className="past-companies animate-fade-in-up" ref={pastCompaniesRef}>
          <div className="past-companies-container">
            <h2 className="past-companies-title">Empresas participantes da Edição de 2026</h2>
            <img
        ...
        <section className="inscription animate-fade-in-up" ref={inscriptionRef} id="inscription">
          <div className="inscription-container">
            ...
            <div className="inscription-cards">
              <Link to="/inovaskill2026/empresa" className="inscription-card card-empresa">
              ...
              <Link to="/inovaskill2026/aluno" className="inscription-card card-aluno">
