...
import '../inovaskill2026/animations.css'
import '../inovaskill2026/Empresa.css'
...
export default function SpaiEmpresaTemplate({ city, groupId }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await subscribeEmpresa(sanitized, groupId)
      setSuccess(true)
      setFormData({
        nome: '',
        email: '',
    ...
    <>
      ...
      <section className="empresa-hero animate-fade-in" ref={heroRef}>
        ...
        <div className="empresa-hero-right">
          <iframe width="560px" height="300" className='sombra' src="https://www.youtube.com/embed/xasiaxZXrfw?si=4f-yYaqOhywpvhee" title="InovaSkill SPAI Empresa" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
        </div>
      </section>
            ...
            <>
              ...
              <form className="empresa-form" onSubmit={handleSubmit}>
                ...
                <div className="lgpd-notice">
                  <p>
                    <strong>Informações sobre seus dados:</strong> Seus dados serão gerenciados pela plataforma <strong>MailerLite</strong>, nosso operador de comunicações, em conformidade com a LGPD. Os dados serão retidos pelo período de vigência do programa e por até <strong>5 anos</strong> após seu encerramento para fins de obrigações legais. Para exercer seus direitos (acesso, correção ou exclusão), entre em contato pelo e-mail{' '}<a href="mailto:lgpd@mentto.com.br">lgpd@mentto.com.br</a>.
                  </p>
                </div>
